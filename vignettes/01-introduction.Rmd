...
vignette: >
   %\VignetteIndexEntry{Introducing R and RStudio}
...
This class is based on the [https://datacarpentry.org/genomics-r-intro](https://datacarpentry.org/genomics-r-intro). 
Mainly just rendered differently. 
...
at Bell Labs and was developed to teach intro statistics.
...
<img src="fig/RStudio.png" alt="rstudio default session" style="width:1000px;"/>
...
To update all your installed packages just type: 
...
Finally there are lots of packages on github. These are often new pacages or development versions. 


```
# Install the remotes package if it's not already there
